...
def printStep5DEBUG(sNum, s, a, b, c, y, ya, ay, baSecComm, abSecComm):
...
def printNotbLcPairs(sNum, tbl, bLcPairs):
    print 'Non-bLc Pairs for S# ' + str(sNum) + ':';
    tbl.printTable();
    if len(bLcPairs) == 0:
        print 'none';
    for (b, c) in bLcPairs:
...
for tbl in tbls:
    ...
    printNotbLcPairs(tableNum, tbl, bLcPairs);
