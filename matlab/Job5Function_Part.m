function Job5Function_Part(orderN, leftTable, rightTable)
...
outputFile = fopen(['JOB5_ORDER_' num2str(orderN) '_TABLES_' num2str(leftTable) '_to_' num2str(rightTable) '.txt'], 'w');
for tableNum = leftTable:rightTable
    tableNum
